...
class Roleplay(commands.Cog):
    ...
    async def givexp(self, ctx, name: discord.Member, points: int):
        if name:
            try:
    ...
    async def setxp(self, ctx, name: discord.Member, points: int):
        if name:
            try:
                user = ctx.message.mentions[0]
            except:
    ...
    async def xp(self, ctx, name: discord.Member):
        if name:
            try:
                user = ctx.message.mentions[0]
            except:
